...
void drawLessons(void){
    ...
    if(weekB){
        drawLesson(3 * lessonWidth, 3 * (lessonHeight + lessonHeightMargin), "Teknik", "H341", colorTeknik, textColorLight, "12:20", "13:40");
        drawLesson(3 * lessonWidth, 4 * (lessonHeight + lessonHeightMargin), "Kemi", "H324La", colorKemi, textColorDark, "14:00", "15:30");
    } else {
        drawLesson(3 * lessonWidth, 3 * (lessonHeight + lessonHeightMargin), "Fysik", "F204La", colorFysik, textColorDark, "12:20", "13:40");
